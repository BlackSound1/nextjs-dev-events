...
const EventDetailItem = (
    { icon, alt, label }: EventDetailItemProps
) => (
...
export default async function EventDetailsPage(
    ...
    const {
        description, image, overview, date,
        time, location, mode, agenda,
        audience, tags, organizer,
    } = event;
            ...
            <div className="details">
                ...
                <aside className="booking">
                    <div className="signup-card">
                        ...
                        {
                            bookings > 0 ? (
                                <p className="text-sm">Join {bookings} people who halve already booked their spot!</p>
                            ): (
